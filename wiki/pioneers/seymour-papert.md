...
학습자는 컴퓨터로 무언가를 만들 때 자신의 사고를 외부화하고 다시 구성한다.[^papert-1980][^dewey-1938]

파퍼트는 Piaget의 구성주의를 컴퓨터 기반 제작 활동으로 확장했다. Logo와 Mindstorms는 프로그래밍을 단순한 기능 습득이 아니라 수학적 사고와 메타인지의 매개로 보게 했다.[^papert-1980][^dewey-1938]

> 가장 좋은 학습은 학습자가 가장 잘 아는 것을 만들어낼 때 일어난다.[^papert-1980]

## 주요 저작

- **Mindstorms** (1980) — 어린이·컴퓨터·강력한 아이디어의 관계를 탐구한 대표 저작.[^papert-1980]

## 구성주의에서 Constructionism으로

Papert는 지식이 학습자의 머릿속에서 구성된다는 구성주의를, 학습자가 다른 사람과 공유할 수 있는 산출물을 만들며 지식을 구성한다는 Constructionism으로 구체화했다. 산출물은 코드일 수도, 로봇일 수도, 설명 가능한 모델일 수도 있다.[^papert-1980]

## 디지털 학습의 윤리

파퍼트의 컴퓨터는 자동화된 정답 기계가 아니라 생각을 실험하는 재료다. 따라서 오늘날의 디지털 학습도 플랫폼 사용 시간보다 학습자가 무엇을 만들고, 실패를 어떻게 수정하며, 자신의 사고를 어떻게 설명하는지로 평가해야 한다.[^papert-1980][^dewey-1938]

## 남아프리카에서 MIT까지

시모어 오브리 파퍼트는 1928년 남아프리카공화국 프리토리아에서 태어났다. 비트바테르스란트대학교에서 수학을 공부하고 케임브리지대학교에서 박사학위를 받은 뒤, 1958년부터 1963년까지 장 피아제와 함께 제네바에서 발달·수학 학습을 연구했다. 이 경험은 아이가 지식을 수동적으로 받는 존재가 아니라 스스로 구성하는 존재라는 그의 생각에 큰 영향을 주었다.[^bio-wiki-papert][^papert-1980]
...
- [[debates/vygotsky-papert]] — 도구와 공동 구성 (상대: 레프 비고츠키)[^vygotsky-1978][^papert-1980]
- [[debates/papert-mayer]] — 만들며 배우기 vs. 설명을 통한 학습 (상대: 리처드 메이어)[^papert-1980][^mayer-1997][^mayer-2005]
- [[debates/jonassen-papert]] — 만들기와 사고도구 (상대: 데이비드 조나센)[^papert-1980][^jonassen-2000]
- [[debates/scardamalia-papert]] — 구성물 제작과 아이디어 개선 (상대: 말린 스카다말리아)[^papert-1980][^scardamalia-1989][^scardamalia-1994]
