...
새 지식은 기존 인지구조와 실질적으로 연결될 때 유의미해지며, 개념지도는 그 연결을 보이고 고치는 도구다.[^bio-novak-cornell][^bio-novak-ihmc][^novak-1984][^novak-2002]

노백은 오수벨의 유의미학습 이론을 장기 과학교육 연구와 연결해 개념지도를 개발했다. 개념과 개념 사이의 명제적 관계를 시각화함으로써 학습자의 사전지식, 오개념, 지식 변화와 평가를 같은 화면에서 다룰 수 있게 했다.[^bio-novak-cornell][^bio-novak-ihmc][^novak-1984][^novak-2002]

> 개념지도는 완성된 지식을 장식하는 그림이 아니라 학습자가 의미를 구성하는 관계를 드러내는 도구다.[^novak-1984]

## 주요 저작

- **Learning How to Learn** (1984) — 개념지도와 V 다이어그램을 학습·교수·평가에 적용한 대표 저서.[^novak-1984]
- **Meaningful Learning** (2002) — 유의미학습과 개념 변화의 관계를 재정리한 논문.[^novak-2002]
...
조지프 도널드 노백은 1930년 12월 2일 미네소타주 미니애폴리스에서 태어났다. 미네소타대학교에서 학사·석사·박사학위를 받고 퍼듀대학교에서 가르친 뒤 1967년 코넬대학교 교육학과 조교수로 합류했다. 초기에는 아동이 과학 개념을 어떻게 배우고 오랫동안 변화시키는지에 집중했다.[^bio-novak-cornell][^bio-novak-ihmc]

## 오수벨의 이론을 개념지도로 번역하다

노백 연구팀은 1970년대 장기 종단연구에서 방대한 아동 면담을 비교하기 위해 개념과 명제의 관계를 시각적으로 표시하는 방법을 발전시켰다. 오수벨의 동화이론은 새 지식이 학습자의 기존 인지구조와 연결되어야 한다는 이론적 기반을 제공했다. 개념지도는 사전지식과 개념 변화를 동시에 기록하는 연구·수업·평가 도구가 됐다.[^bio-novak-ihmc][^novak-1984][^novak-2002]

## CmapTools와 세계적 확산

1984년 D. Bob Gowin과 쓴 『Learning How to Learn』은 개념지도와 V 다이어그램의 사용법을 체계화했다. 코넬대학교 명예교수가 된 뒤에는 Florida Institute for Human & Machine Cognition에서 디지털 개념지도 도구 CmapTools의 이론적 발전에 참여했다. 29권의 책과 100편 이상의 논문을 남긴 그는 2023년 9월 22일 플로리다에서 사망했다.[^novak-1984][^bio-novak-cornell][^bio-novak-ihmc]

## 당대의 비판

제롬 브루너는 지식의 구조를 학습자에게 완성된 위계로 건네기보다 탐구와 발견을 통해 파악하게 해야 한다고 보았다. 이 입장에서 보면 개념지도가 교사가 정한 개념 위계와 연결어를 정답처럼 제시할 때, 학습자의 의미 구성과 발견을 돕는 도구가 아니라 특정 표상 형식에 맞추는 양식으로 오용될 수 있다.[^bruner-1960][^novak-1984]

리처드 메이어의 멀티미디어 학습 연구는 표상을 많이 보여 주는 것보다 학습자가 핵심 정보를 선택하고 조직하고 기존 지식과 통합하도록 돕는 설계가 중요하다고 본다. 이 비판은 개념지도의 시각적 관계망 자체를 학습 효과로 간주하지 말고, 연결의 수와 배치가 학습자의 인지부하와 의미 통합에 어떤 영향을 주는지 따져야 한다는 점을 제기한다.[^mayer-2005]

## 한계

개념지도는 학습자가 개념을 구별하고, 연결어를 고르고, 명제와 위계 관계를 언어로 표현할 수 있다는 전제 위에서 가장 잘 작동한다. 따라서 아직 어휘와 개념 체계가 형성되지 않았거나 언어로 명시하기 어려운 절차적·암묵적 지식에서는 지도가 지식 전체를 그대로 보여 주지 못한다.[^novak-1984]
...
- **1972** 개념지도의 개발 — 아동의 과학 개념 변화를 추적하는 연구에서 개념지도를 발전시켰다.[^bio-novak-ihmc]
- **1984** Learning How to Learn — 개념지도와 V 다이어그램의 이론과 활용을 체계화했다.[^novak-1984]

## 대립축

- [[debates/bruner-novak]] — 발견과 유의미한 연결 (상대: 제롬 브루너)[^bruner-1960][^novak-1984]
- [[debates/novak-mayer]] — 개념도와 멀티미디어 표상 (상대: 리처드 메이어)[^novak-1984][^novak-2002][^mayer-2005]

[^bio-novak-cornell]: Krisy Gashler. (2023). Joseph Novak, pioneer of education theory, dies at 92. Cornell Chronicle. <https://news.cornell.edu/stories/2023/11/joseph-novak-pioneer-education-theory-dies-92> — tier B · [[sources/bio-novak-cornell]]
[^bio-novak-ihmc]: Joseph D. Novak; IHMC. (2018). A Search to Create a Science of Education. Florida Institute for Human & Machine Cognition. <https://www.ihmc.us/joseph-novak/> — tier A · [[sources/bio-novak-ihmc]]
