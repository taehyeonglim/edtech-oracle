...
어떤 교과도 학습자의 사고 수준에 맞는 구조와 표현으로 재구성할 수 있다.[^bruner-1960][^bruner-1966][^schunk-2012]

브루너는 학습자의 능동적 의미 구성, 지식의 구조, 나선형 교육과정, 발견학습을 강조했다. 교육 내용을 단순화하되 구조를 잃지 않는 설계와 스캐폴딩의 언어는 디지털 학습에도 큰 영향을 주었다.[^bruner-1960][^bruner-1966][^schunk-2012]

> 어떤 교과도 지적으로 정직한 형태라면 어떤 발달 단계의 아동에게도 가르칠 수 있다.[^bruner-1960]

## 주요 저작

- **The Process of Education** (1960) — 지식의 구조와 나선형 교육과정의 교육적 의미를 제시했다.[^bruner-1960]
- **Toward a Theory of Instruction** (1966) — 학습자의 표현 양식과 수업 지원을 이론화했다.[^bruner-1966]

## 발견은 방임이 아니다

브루너의 발견학습은 학습자를 아무 안내 없이 두는 것을 뜻하지 않는다. 핵심 개념의 구조를 탐구할 수 있도록 질문, 자료, 순서를 설계하고, 학습자가 규칙과 관계를 스스로 표현하도록 지원하는 방식이다.[^bruner-1960][^bruner-1966]

## 표상과 재표상

행동적·영상적·상징적 표현은 고정된 연령 단계라기보다 지식을 다루는 서로 다른 방식으로 읽을 수 있다. 멀티미디어 설계에서는 한 표현을 다른 표현으로 번역할 때 무엇이 보존되고 무엇이 손실되는지 점검하게 한다.[^bruner-1966][^mayer-2005]
...
브루너는 어떤 교과도 학습자의 사고 수준에 맞는 구조와 표현으로 재구성할 수 있다고 주장했다.[^bruner-1960] 이에 대해 피아제의 발생적 인식론은 인지 구조가 활동 속에서 발달하고 재조직된다는 점을 강조했다. 이 관점은 교육과정의 재표상만으로 모든 발달적 제약을 넘을 수 있다는 해석에 제동을 건다.[^piaget-1970]

조지프 노백은 발견학습에 대해 다른 요구를 제시했다. 새 지식은 학습자의 기존 인지구조와 실질적으로 연결되어야 하며, 학습자가 규칙을 찾아냈다는 사실만으로 유의미한 학습이 보장되지는 않는다는 것이다. 따라서 발견의 기회와 함께 개념 사이의 관계를 명시적으로 조직하고 고치는 지원이 필요하다.[^novak-1984]

## 한계

브루너의 이론은 교과의 구조를 식별하고 그것을 행동적·영상적·상징적 표현으로 재구성할 수 있다는 전제를 둔다. 그러나 어떤 표현이 특정 학습자에게 적절한지, 발견 과정에 어느 정도의 안내가 필요한지는 교과와 학습자의 사전 지식에 따라 달라지므로 원리만으로 자동 결정되지 않는다.[^bruner-1960][^bruner-1966][^schunk-2012]

나선형 교육과정을 같은 내용을 정해진 간격으로 반복하는 일정표로 사용하거나, 발견학습을 안내 없는 탐색으로 줄이는 것은 브루너의 설계를 오용하는 방식이다. 표상 양식을 바꾸는 일만으로 학습이 일어나는 것도 아니며, 정보의 선택·조직·통합이라는 인지 처리 조건을 함께 검토해야 한다.[^bruner-1966][^mayer-2005]
...
- [[debates/bruner-mayer]] — 표상과 설명 (상대: 리처드 메이어)[^bruner-1966][^mayer-2005]
- [[debates/piaget-bruner]] — 발달 구조와 표상·문화 (상대: 장 피아제)[^piaget-1970][^bruner-1960][^bruner-1966]
