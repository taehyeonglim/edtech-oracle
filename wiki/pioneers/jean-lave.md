...
학습은 개인의 머릿속에 지식을 저장하는 사건이 아니라 사회적 실천에 참여하는 방식이 변하는 과정이다.[^bio-lave-berkeley][^bio-lave-authority][^lave-1988][^lave-wenger-1991]

레이브는 일상 수학과 도제학습의 민족지 연구를 통해 인지가 활동·도구·문화와 분리될 수 없음을 보였다. 웽거와 제시한 정당한 주변적 참여는 학습을 공동체 참여와 정체성 변화로 이해하게 했다.[^bio-lave-berkeley][^bio-lave-authority][^lave-1988][^lave-wenger-1991]

> 학습은 지식의 획득만이 아니라 변화하는 사회적 실천에 참여하는 일이다.[^lave-wenger-1991]

## 주요 저작

- **Cognition in Practice** (1988) — 일상 활동의 산술과 학교식 문제 해결을 비교해 인지의 상황성을 논증했다.[^lave-1988]
- **Situated Learning** (1991) — 에티엔 웽거와 정당한 주변적 참여를 통해 도제학습과 공동체 참여를 이론화했다.[^lave-wenger-1991]
...
1988년 『Cognition in Practice』는 장보기와 가정생활에서 사람들이 사용하는 계산을 조사했다. 같은 사람이 학교식 문항과 실제 상황에서 다른 전략을 쓸 수 있다는 결과는 지식을 맥락과 분리된 일반 능력으로 가정하는 관점을 흔들었다. 도구·목적·사회적 관계가 사고의 일부라는 점이 핵심이다.[^lave-1988]

## 정당한 주변적 참여와 공동체

1991년 에티엔 웽거와 쓴 『Situated Learning』은 초보자가 실천공동체의 주변에서 실제적이고 낮은 위험의 활동에 참여하며 책임과 정체성을 바꾸는 과정을 정당한 주변적 참여로 설명했다. 이는 단순히 전문가를 관찰하거나 교실을 현실처럼 꾸미라는 기법이 아니다. 접근 권한, 공동체 관계, 참여 궤적을 함께 설계해야 한다.[^lave-wenger-1991][^bio-lave-berkeley]

## 당대의 비판

콜린스·브라운·뉴먼은 인지적 도제에서 모델링·코칭·스캐폴딩·명료화·반성·탐색을 설계 요소로 명시했다.[^collins-1989] 실제 공동체에 참여하는 것을 학습의 핵심으로 보는 레이브의 설명[^lave-wenger-1991]에 대해서는, 참여만으로는 전문가의 암묵적 사고 과정을 초보자가 볼 수 없으며 참여를 학습으로 연결하는 교수적 지원이 필요하다는 반론이 제기된다.[^collins-1989]

조나센은 문제해결 설계에서 문제의 유형과 표상, 학습자의 영역 지식을 함께 고려해야 한다고 제안했다.[^jonassen-2000] 상황과 참여를 강조하는 레이브의 이론[^lave-wenger-1991]에 대해서는, 어떤 지식 구조와 지원이 필요한지에 대한 설계 언어를 충분히 제공하지 않는다는 비판이 제기될 수 있다.[^jonassen-2000]

## 한계

레이브의 『Cognition in Practice』는 같은 사람이 장보기와 학교식 문제에서 서로 다른 계산 전략을 사용할 수 있음을 보여주며 인지의 상황성을 강조한다. 그러나 이 관점만으로는 한 상황에서 형성된 지식과 전략이 다른 상황으로 이동하는 조건을 구체적으로 설명하기 어렵다.[^lave-1988]

정당한 주변적 참여는 초보자에게 실제 공동체에 접근하고 가치 있는 활동에 참여하며 책임이 이동하는 경로가 있다는 것을 전제한다. 공동체가 폐쇄적이거나 참여 권한이 없으면 이론의 핵심 메커니즘을 구현할 수 없다.[^lave-wenger-1991]

## 연표

- **1988** Cognition in Practice — 일상 인지를 민족지적으로 연구해 학교 밖 사고의 상황성을 보였다.[^lave-1988]
- **1991** Situated Learning — 정당한 주변적 참여와 도제학습의 사회적 구조를 웽거와 제시했다.[^lave-wenger-1991]
- **2011** 학습을 사회적 실천으로 — 버클리 강연에서 학습을 가르침의 효과가 아니라 변화하는 사회생활의 이론으로 재강조했다.[^bio-lave-berkeley]

## 대립축

- [[debates/lave-vygotsky]] — 사회적 매개와 상황적 실천 (상대: 레프 비고츠키)[^vygotsky-1978][^lave-1988][^lave-wenger-1991]
- [[debates/lave-jonassen]] — 상황적 인지와 실제적 문제 (상대: 데이비드 조나센)[^lave-1988][^lave-wenger-1991][^jonassen-1991][^jonassen-2000]
- [[debates/lave-collins]] — 참여와 인지적 도제 (상대: 앨런 콜린스)[^lave-wenger-1991][^collins-1989]
