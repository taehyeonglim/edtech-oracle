...
초보자의 제한된 작업기억을 불필요하게 소모하지 않도록 정보와 활동을 조직해야 학습이 촉진된다.[^bio-sweller-unsw][^sweller-2016-story][^sweller-1988][^sweller-2011]

스웰러는 문제해결 연구에서 출발해 작업기억과 장기기억의 구조를 교수설계와 연결했다. 해결 예제 효과, 주의분할 효과, 전문성 역전 효과는 학습자의 사전지식에 따라 안내의 양을 조절해야 함을 보여준다.[^bio-sweller-unsw][^sweller-2016-story][^sweller-1988][^sweller-2011]

> 문제를 푸는 인지 과정과 그 문제에서 학습하는 인지 과정은 항상 같지 않다.[^sweller-1988]

## 주요 저작

- **Cognitive Load During Problem Solving** (1988) — 수단–목표 문제해결이 학습에 필요한 도식 형성을 방해할 수 있음을 분석한 기초 논문.[^sweller-1988]
- **Cognitive Load Theory** (2011) — 인지구조, 부하 효과, 교수설계 원리를 공동 저자들과 종합한 연구서.[^sweller-2011]
...
존 스웰러는 1946년생 호주 교육심리학자로 1972년 애들레이드대학교에서 박사학위를 받았다. 뉴사우스웨일스대학교에서 문제해결자가 목표와 현재 상태의 차이를 반복해서 줄이는 수단-목표 분석에 집중할 때, 풀이에 필요한 일반화 가능한 구조를 충분히 학습하지 못할 수 있음을 연구했다.[^bio-sweller-unsw][^sweller-2016-story][^sweller-1988]
...
- **1988** 인지부하 핵심 논문 — 문제해결 전략이 학습에 부과하는 인지적 비용을 이론화했다.[^sweller-1988]
