...
매체는 기억률 순위표가 아니라 학습 경험의 구체성과 추상성을 조절하는 설계 자원이다.[^bio-dale-osu][^dale-1946][^molenda-2003-cone]

데일은 영화·라디오·사진·모형·직접 경험을 교육적으로 분류한 ‘경험의 원추’로 시청각교육의 언어를 정리했다. 오늘날 널리 퍼진 기억률 백분율 피라미드는 데일의 연구가 아니므로 분명히 구분해야 한다.[^bio-dale-osu][^dale-1946][^molenda-2003-cone]

> 경험의 원추는 고정된 위계가 아니라 경험 형식 사이의 관계를 생각하는 시각적 비유다.[^molenda-2003-cone]
...
원추의 아래쪽은 직접·참여적 경험, 위쪽은 언어·상징처럼 추상적인 표현을 놓는다. 이는 어떤 매체가 항상 우월하다는 순위가 아니라, 목표와 학습자의 사전 경험에 맞춰 구체성과 추상성을 오갈 수 있도록 설계하는 분류다.[^dale-1946][^molenda-2003-cone]

## 기억률 피라미드는 데일의 것이 아니다
...
1946년 『Audio-Visual Methods in Teaching』에 제시한 경험의 원추는 구체적 참여에서 언어적 상징까지 경험의 추상성 정도를 연속적으로 생각하게 하는 모형이었다. 특정 매체의 학습효과 순위나 기억률을 제시한 표가 아니며, 데일 자신도 원추의 층위를 경직된 위계나 수업 순서로 다루지 않았다.[^dale-1946][^molenda-2003-cone]

## 가짜 기억률 피라미드와의 분리

데일은 1970년 오하이오주립대학교에서 은퇴했고 1985년 사망했다. 그의 이름에는 출처 없는 ‘읽으면 10%, 행동하면 90% 기억한다’는 수치 피라미드가 자주 붙지만, 이는 원저작에 없는 후대의 결합물이다. 교육공학자는 원추를 매체 선택의 만능 공식이 아니라 경험의 구체성과 상징성을 토론하는 역사적 도구로 읽어야 한다.[^bio-dale-osu][^dale-1946][^molenda-2003-cone]

## 당대의 비판

데일은 경험을 구체성에서 추상성으로 이어지는 형식의 연속체로 분류했다.[^dale-1946] 리처드 메이어는 멀티미디어 학습을 매체의 위치나 경험의 거리보다 학습자가 제한된 인지 자원 안에서 정보를 선택·조직·통합하는 과정으로 분석했다. 이 관점에서는 같은 매체라도 제시 방식과 인지 처리 조건에 따라 학습 결과가 달라질 수 있다.[^mayer-2005]

몰렌다는 경험의 원추를 고정된 위계나 수업 순서로 읽는 해석을 비판했다. 그의 검토에서 원추는 경험 형식을 생각하게 하는 시각적 비유이지, 각 층의 기억률이나 매체 효과를 실험으로 서열화한 결과가 아니다. 따라서 원추를 하위 경험이 상위 경험보다 우월하다는 규칙으로 쓰는 것은 데일의 모형에 대한 과잉 해석이다.[^molenda-2003-cone]

## 한계

데일 자신이 제시한 원추는 경험 형식의 관계와 추상성 차이를 조직하는 틀이지, 특정 매체가 언제나 더 잘 가르친다는 설명 모형이 아니다. 그러므로 어떤 매체를 선택해야 하는지, 학습자가 무엇을 기억하고 전이할지는 원추만으로 예측할 수 없다.[^dale-1946][^molenda-2003-cone]

원추의 구체성·추상성 축은 학습자가 정보를 선택·조직·통합하는 인지 처리의 세부 과정까지 설명하지 않는다. 원추의 층위를 기억률 공식으로 바꾸거나 매체의 우열표로 사용하는 것은, 원추가 제공하는 분류의 범위를 넘어선 오용이다.[^mayer-2005][^molenda-2003-cone]
