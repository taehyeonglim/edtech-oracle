...
학습 환경의 결과 구조를 바꾸면 행동의 빈도와 형태를 체계적으로 바꿀 수 있다.[^skinner-1954][^skinner-1957][^reiser-2017]

스키너는 조작적 조건형성과 강화의 원리를 인간 행동과 교육에 적용했다. 1954년 논문은 프로그램 학습과 교수기계 논의를 촉발했으며, 현대의 즉각적 피드백 설계에도 흔적을 남겼다.[^skinner-1954][^skinner-1957][^reiser-2017]

> 가르치는 것은 학습이 일어나도록 조건을 배열하는 일이다.[^skinner-1954]

## 주요 저작

- **The Science of Learning and the Art of Teaching** (1954) — 학습과학을 수업 설계와 교수기계로 연결한 논문.[^skinner-1954]
- **Verbal Behavior** (1957) — 언어 행동을 행동분석의 관점에서 설명한 저작.[^skinner-1957]
...
행동주의 설계는 관찰 가능한 목표와 피드백을 명료하게 만드는 강점이 있다. 반면 의미 구성, 전이, 맥락적 이해처럼 외부 행동만으로 포착하기 어려운 학습을 설명하려면 다른 이론과의 보완이 필요하다.[^skinner-1954][^schunk-2012]
...
스키너는 제2차 세계대전 시기 비둘기를 이용한 유도 미사일 연구인 Project Pigeon에 참여했고, 이후 조작적 조건형성·강화 일정·행동의 선택을 실험실에서 정교화했다. 1954년 논문은 학습의 과학과 수업의 기술을 연결하며 교수기계와 프로그램 학습을 제안했다. 이 경험은 교육을 환경 조건의 설계 문제로 보는 관점을 강화했다.[^bio-wiki-skinner][^skinner-1954][^skinner-1957]
...
- **1954** The Science of Learning — 교수기계와 프로그램 학습의 교육적 가능성을 제안했다.[^skinner-1954]
- **1957** Verbal Behavior — 언어 행동을 행동분석의 틀에서 다루었다.[^skinner-1957]
