...
title: 참여와 지식구축
type: debate
related: ["[[pioneers/etienne-wenger-trayner]]", "[[pioneers/marlene-scardamalia]]"]
updated: 2026-08-14
sources: [scardamalia-1994, wenger-1998]
confidence: high
---

## 쟁점

웽거는 공동 실천 속 참여와 정체성을, 스카더말리아는 공동체의 아이디어를 공공재로 개선하는 지식구축을 강조해 협력학습의 서로 다른 분석 단위를 제시한다.[^wenger-1998][^scardamalia-1994]

## 양측

- [[pioneers/etienne-wenger-trayner]] 에티엔 웽거-트레이너 — 학습은 지식의 소유만이 아니라 공동의 실천에 참여하며 의미·소속·정체성을 협상하는 과정이다.[^wenger-1998]
- [[pioneers/marlene-scardamalia]] 말린 스카다말리아 — 학교의 집단 담화는 정답 공유를 넘어 공동체의 아이디어를 지속적으로 개선하는 지식구축 활동이 될 수 있다.[^scardamalia-1994]
